...
func Kategori(c echo.Context) error {
...
func KategoriById(c echo.Context) error {
	var data models.Kategori
...
func KategoriCreate(c echo.Context) error {
	var request models.KategoriRequest
	if err := c.Bind(&request); err != nil {
		return c.JSON(500, helpers.ResponseFail("-"))
	}

	data := models.RequestToModelKategori(request)
...
func KategoriUpdate(c echo.Context) error {
	var request models.KategoriRequest
	if err := c.Bind(&request); err != nil {
		return c.JSON(500, helpers.ResponseFail("-"))
	}
